...
print("=" * 76)
print("STEP-8 PRIMARY INFERENCE — CHGNet")
print("=" * 76)

print("Loading frozen bundle...")
...
print("\n" + "=" * 76)
print("CHGNet PRIMARY INFERENCE AUDIT")
print("=" * 76)
...
if final["complete"]:
    print("\nCHGNet STEP8 PRIMARY INFERENCE: PASS")
else:
    print("\nCHGNet STEP8 PRIMARY INFERENCE: REVISE")
