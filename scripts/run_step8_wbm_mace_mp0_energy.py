...
CHECKPOINT = Path(
    "model_weights/mace_mp0/"
    "mace_mp_0.model"
)

EXPECTED_CHECKPOINT_SHA = (
    "01bfe22100139f424713cf921144e550"
    "9cbe353d67aa9fa1be9c6e1e0ed35845"
)

OUTDIR = Path(
    "step8/controls/wbm/"
    "predictions/MACE-MP-0"
)
OUTDIR.mkdir(
    parents=True,
    exist_ok=True,
...
print("=" * 78)
print(
    "STEP-8 WBM ENERGY CONTROL — MACE-MP-0"
)
print("=" * 78)
...
# ==========================================================
# Exact verified MACE-MP-0 loader
# ==========================================================
...
# ==========================================================
# Static single-point energy inference
# ==========================================================
...
for i, rec in enumerate(
    ...
    if (
        ...
        progress = {
            "stage":
                "STEP8_WBM_MACE_MP0_ENERGY_INFERENCE",
...
print("=" * 78)
print(
    "WBM MACE-MP-0 ENERGY INFERENCE AUDIT"
)
print("=" * 78)
