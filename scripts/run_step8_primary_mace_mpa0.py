...
CACHE = Path.home() / ".cache/mace/macempa0mediummodel"
...
print("=" * 76)
print("STEP-8 PRIMARY INFERENCE — MACE-MPA-0")
print("=" * 76)

assert CACHE.exists(), CACHE

actual_sha = sha256(CACHE)

print("Checkpoint SHA256:", actual_sha)

assert actual_sha == EXPECTED_SHA256, (
    "MACE-MPA-0 checkpoint hash mismatch"
)
...
# =========================================================
# Exact loader verified in 60/60 real pilot
# =========================================================
...
final = {
    "model": "MACE-MPA-0",
    "runtime_model": "medium-mpa-0",
    "checkpoint_cache": str(CACHE),
...
print("\n" + "=" * 76)
print("MACE-MPA-0 PRIMARY INFERENCE AUDIT")
print("=" * 76)
