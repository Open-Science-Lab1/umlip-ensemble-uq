...
print("=" * 76)
print("STEP-8 PRIMARY INFERENCE — eqV2-S-DeNS")
print("=" * 76)
...
# =========================================================
# Exact calculator construction verified in TiO test
# =========================================================
...
print("\n" + "=" * 76)
print("eqV2-S-DeNS PRIMARY INFERENCE AUDIT")
print("=" * 76)
