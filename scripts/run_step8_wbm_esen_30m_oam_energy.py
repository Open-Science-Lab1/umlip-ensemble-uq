...
# ==========================================================
# Explicit reproducible eSEN loader
# ==========================================================
...
for i, rec in enumerate(
    ...
    if (
        ...
        try:
            ...
            # Static single-point inference only.
            # NO eSEN geometry relaxation.
            atoms.calc = calc
    ...
    if (
        ...
        progress = {
            "stage":
                "STEP8_WBM_ESEN_30M_OAM_ENERGY_INFERENCE",
...
print("=" * 78)
print(
    "WBM eSEN-30M-OAM ENERGY INFERENCE AUDIT"
)
print("=" * 78)
...
print(
    "\neSEN-30M-OAM WBM ENERGY CONTROL:",
    status,
)
