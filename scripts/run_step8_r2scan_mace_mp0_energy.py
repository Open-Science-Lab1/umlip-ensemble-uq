...
print("=" * 78)
print("STEP-8 r2SCAN ENERGY CONTROL — MACE-MP-0")
print("=" * 78)
...
assert (
    checkpoint_sha
    == EXPECTED_SHA256
), "MACE-MP-0 checkpoint SHA mismatch"
...
audit = {
    "stage":
        "STEP8_R2SCAN_MACE_MP0_ENERGY_INFERENCE",
...
print("\n" + "=" * 78)
print("r2SCAN MACE-MP-0 ENERGY INFERENCE AUDIT")
print("=" * 78)
...
print(
    "\nMACE-MP-0 r2SCAN ENERGY CONTROL:",
    status,
)
