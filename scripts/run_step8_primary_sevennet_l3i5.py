...
OUTDIR = Path(
    "step8/predictions/SevenNet-l3i5"
)
...
print("=" * 76)
print("STEP-8 PRIMARY INFERENCE — SevenNet-l3i5")
print("=" * 76)
...
# Exact loader already verified in the real TiO smoke test.
...
final = {
    ...
    "checkpoint": str(CHECKPOINT),
    "expected_configs": 3000,
    "available_prediction_files": int(available),
    "failures": failures,
    "complete": (
        available == 3000
        and len(failures) == 0
...
print("\n" + "=" * 76)
print("SevenNet-l3i5 PRIMARY INFERENCE AUDIT")
print("=" * 76)
...
if final["complete"]:
    print(
        "\nSevenNet-l3i5 STEP8 PRIMARY INFERENCE: PASS"
    )
else:
    print(
        "\nSevenNet-l3i5 STEP8 PRIMARY INFERENCE: REVISE"
    )
