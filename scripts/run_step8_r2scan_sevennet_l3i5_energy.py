...
CHECKPOINT = Path(
    "model_weights/sevennet/sevennet_l3i5.pth"
)

EXPECTED_SHA256 = (
    "a7ff190d41efe5b8317a03d20a468e4036a1a3e64e0b14fdbab64ac3f4bfc09d"
)
...
print("=" * 78)
print("STEP-8 r2SCAN ENERGY CONTROL — SevenNet-l3i5")
print("=" * 78)
...
assert checkpoint_sha == EXPECTED_SHA256, (
    "SevenNet-l3i5 checkpoint SHA mismatch"
)
...
audit = {
    "stage":
        "STEP8_R2SCAN_SEVENNET_L3I5_ENERGY_INFERENCE",
...
print("\n" + "=" * 78)
print("r2SCAN SevenNet-l3i5 ENERGY INFERENCE AUDIT")
print("=" * 78)
...
print(
    "\nSevenNet-l3i5 r2SCAN ENERGY CONTROL:",
    status,
)
