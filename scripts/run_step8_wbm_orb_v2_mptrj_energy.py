...
print("=" * 78)
print(
    "STEP-8 WBM ENERGY CONTROL — ORB-v2-MPtrj"
)
print("=" * 78)
...
assert set(index_lookup) == set(record_lookup)
...
print(
    "ORB-v2-MPtrj LOAD: PASS"
)


# ==========================================================
# Static WBM inference
# ==========================================================
...
for i, rec in enumerate(
    ...
    if (
        ...
        progress = {
            "stage":
                "STEP8_WBM_ORB_V2_MPTRJ_ENERGY_INFERENCE",
...
print("=" * 78)
print(
    "WBM ORB-v2-MPtrj ENERGY INFERENCE AUDIT"
)
print("=" * 78)
...
print(
    "\nORB-v2-MPtrj WBM ENERGY CONTROL:",
    status,
)
