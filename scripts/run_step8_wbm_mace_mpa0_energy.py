...
CACHE = (
    Path.home()
    / ".cache/mace/macempa0mediummodel"
)
...
print("=" * 78)
print(
    "STEP-8 WBM ENERGY CONTROL — MACE-MPA-0"
)
print("=" * 78)
...
# ==========================================================
# Exact verified MACE-MPA loader
# ==========================================================
...
for i, rec in enumerate(
    ...
    if (
        ...
        progress = {
            "stage":
                "STEP8_WBM_MACE_MPA0_ENERGY_INFERENCE",
...
print("=" * 78)
print(
    "WBM MACE-MPA-0 ENERGY INFERENCE AUDIT"
)
print("=" * 78)
